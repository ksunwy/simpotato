...
const Footer = ({ footerRef }: { footerRef: any }) => {
  return (
    <footer ref={footerRef} id="footer" className="footer overflow-hidden relative w-full h-fit md:h-[52.82rem] bg-blue flex flex-col gap-[60px] md:gap-[9.16rem] py-[50px] md:py-[4.4rem] text-white bg-(--blue)">
      ...
      <div className="footer-content flex flex-col gap-10 width-restrictions">
        <div className="flex md:flex-row flex-col md:items-center gap-9">
          <div className="flex flex-col">
            <a href="mailto:control@x5.ru"><span className="text-[16px] md:text-[2.05rem] font-medium">control@x5.ru</span></a>
            <span className="text-[16px] md:text-[2.05rem]">Viber, Telegram: <span className="font-medium">@ks5_bot</span> </span>
          </div>
          <div className="flex flex-col">
            <a href="tel:88005555505"><span className="text-[16px] md:text-[2.05rem] font-medium">8-800-555-55-05</span></a>
            <span className="text-[16px] md:text-[2.05rem]">WhatsApp: <span className="font-medium">+7 986 555-55-05</span></span>
          </div>
        </div>

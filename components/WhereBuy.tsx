...
const WhereBuy = ({wherebuyRef}: {wherebuyRef: any}) => {
  return (
    <section ref={wherebuyRef} id="wherebuy" className="where-title overflow-hidden w-dvw h-fit md:h-[78.93rem] width-restrictions flex flex-col justify-center py-[50px] md:py-0 gap-[40px] md:gap-[8.04rem]">
      <h3 className="where-title uppercase font-bold text-(--blue) text-[33px] md:text-[5.47rem]">где купить</h3>

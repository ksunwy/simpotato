...
const WhereBuy = ({wherebuyRef}: {wherebuyRef: any}) => {
  return (
    <section ref={wherebuyRef} id="wherebuy" className="w-dvw h-[78.93rem] width-restrictions flex flex-col justify-center gap-[8.04rem]">
      <h3 className="uppercase font-bold text-(--blue) text-[5.47rem]">где купить</h3>
      <div className="grid grid-cols-3 items-center w-full gap-[1.71rem]">
        <div className="bg-(--white) rounded-lg shadow-[4px_4px_14.8px_rgba(100,118,151,0.25)] hover:shadow-[4px_4px_15.4px_7px_rgba(71,130,240,0.25)] transition-all duration-300 cursor-pointer w-[39.89rem] h-[18.32rem] px-[1.37rem] flex items-center justify-center">

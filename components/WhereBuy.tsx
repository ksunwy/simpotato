...
const WhereBuy = ({wherebuyRef}: {wherebuyRef: any}) => {
  return (
    <section ref={wherebuyRef} id="wherebuy" className="where-title w-dvw h-fit md:h-[78.93rem] width-restrictions flex flex-col justify-center py-[50px] md:py-0 gap-[40px] md:gap-[8.04rem]">
